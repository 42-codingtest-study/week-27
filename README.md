...
1. 웹에서 https://github.com/42-codingtest-study/week-27 창을 켭니다.
...
[이 문제집](https://www.acmicpc.net/workbook/by/BaaaaaaaaaaarkingDog)에서 6강(구, 신버전 둘 다), 7강(구버전)까지 풀어오기 (더 풀어도 상관 없음)
